import { allPass, always, cond, includes, pipe as _, prop, equals, propEq, propOr, T, test, trim } from 'ramda'
...
export const msgToCategory = cond([
  ...
  [_(prop('message'), allPass([
    includes('RemoteServiceUnavailable'),
    _(propOr('', 'category'), equals('SubscribeEHAssetWorker')),
  ])), always('assetcentral')],
