...
const whoNeedsReact = () => {
  ...
  chrome.storage.sync.get('values', ({ values = {} }) => {
    ...
    const prodUrl = `https://app.logz.io/#/dashboard/kibana/discover/71e09880-f4a0-11e9-9eaa-738762dd3167?_a=(columns:!(app,message),filters:!(('$state':(store:appState),meta:(alias:KafkaRebalancing,disabled:!f,index:'logzioCustomerIndex*',key:message,negate:!t,params:(query:'*Error%20sending%20heartbeat:%20Kafka::RebalanceInProgress*'),type:phrase),query:(match:(message:(query:'*Error%20sending%20heartbeat:%20Kafka::RebalanceInProgress*',type:phrase)))),('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'logzioCustomerIndex*',key:function_name,negate:!t,params:(query:connected-support),type:phrase),query:(match:(function_name:(query:connected-support,type:phrase))))),index:'logzioCustomerIndex*',interval:auto,query:(language:lucene,query:'app:%20(backup%20OR%20blog%20OR%20entry%20OR%20fwr30-lambda%20OR%20health%20OR%20hub%20OR%20iba%20OR%20id%20OR%20inventory%20OR%20library%20OR%20technical-support%20OR%20value%20OR%20wqwa%20OR%20long-term-tests%20OR%20netilion-mqtt-kafka-gateway)%20AND%20(level:(error%20OR%20fatal)%20OR%20log_level:(error%20OR%20fatal%20OR%20ERROR%20OR%20FATAL)%20OR%20at:(error%20OR%20fatal)%20OR%20http_status:500)%20AND%20NOT%20_exists_:edge_device%20AND%20env:production'),sort:!(!('@timestamp',desc)))&_g=(filters:!())&switchToAccountId=18342`
    const stageUrl = `https://app.logz.io/#/dashboard/kibana/discover/d7104bb0-e895-11e7-bbea-a306668ce3b3?_a=(columns:!(app,message),filters:!(('$state':(store:appState),meta:(alias:KafkaRebalancing,disabled:!f,index:'logzioCustomerIndex*',key:message,negate:!t,params:(query:'*Error%20sending%20heartbeat:%20Kafka::RebalanceInProgress*'),type:phrase),query:(match:(message:(query:'*Error%20sending%20heartbeat:%20Kafka::RebalanceInProgress*',type:phrase)))),('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'logzioCustomerIndex*',key:function_name,negate:!t,params:(query:connected-support),type:phrase),query:(match:(function_name:(query:connected-support,type:phrase))))),index:'logzioCustomerIndex*',interval:auto,query:(language:lucene,query:'app:%20(backup%20OR%20blog%20OR%20entry%20OR%20fwr30-lambda%20OR%20health%20OR%20hub%20OR%20iba%20OR%20id%20OR%20inventory%20OR%20library%20OR%20technical-support%20OR%20value%20OR%20wqwa%20OR%20long-term-tests%20OR%20netilion-mqtt-kafka-gateway)%20AND%20(level:(error%20OR%20fatal)%20OR%20log_level:(error%20OR%20fatal%20OR%20ERROR%20OR%20FATAL)%20OR%20at:(error%20OR%20fatal)%20OR%20http_status:500)%20AND%20NOT%20_exists_:edge_device%20AND%20env:staging'),sort:!(!('@timestamp',desc)))&_g=(filters:!())&switchToAccountId=18342&accountIds=true`
